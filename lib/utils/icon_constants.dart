class IconConstants {
  ...
  // Illustrations
  static const String emptyHistory = '$imagePath/illustrations/empty_history.png';
  ...
  static Widget getIcon(String assetPath, {
  ...
  static Future<void> precacheAssets(BuildContext context) async {
    final assets = [
      bottle, droplet, poop, clock,
      history, settings, export, notification,
      appIcon, splashLogo,
      emptyHistory, welcomeBaby, feedingTime,
    ];
